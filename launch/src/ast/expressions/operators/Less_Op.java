...
public class Less_Op extends BinaryExpression {
    public Less_Op(Expression opnd1, Expression opnd2, int row) {
        super(opnd1, opnd2, row);
        this.type = new Bool_Type(row);
        this.operator = Operator_T.LESS;
    }
    ...
    public void generateAddress(Josito jose) throws Exception {
        throw new InvalidDirectionException("Less operation is not directionable");
    }
}
