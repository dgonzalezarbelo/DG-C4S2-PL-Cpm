...
public class Greater_Or_Eq_Op extends BinaryExpression {
    ...
    public void generateAddress(Josito jose) throws Exception {
        throw new InvalidDirectionException("Greater or equal operation is not directionable");
    }
}
